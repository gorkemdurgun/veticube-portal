  ...
  theme: {
    ...
    extend: {
      backgroundImage: {
        ...
        "gradient-green-0-50": "linear-gradient(180deg, #fff 0%, #ecfdf8 100%)",
        "gradient-green-0-50-reverse": "linear-gradient(180deg, #ecfdf8 0%, #fff 100%)",
        ...
        "gradient-green-0-100": "linear-gradient(180deg, #fff 0%, #d1faed 100%)",
        "gradient-green-0-100-reverse": "linear-gradient(180deg, #d1faed 0%, #fff 100%)",
        ...
        "gradient-green-0-200": "linear-gradient(180deg, #fff 0%, #a7f3db 100%)",
        "gradient-green-0-200-reverse": "linear-gradient(180deg, #a7f3db 0%, #fff 100%)",
        ...
        "gradient-green-50-300": "linear-gradient(180deg, #ecfdf8 0%, #6ee7c1 100%)",
        "gradient-green-50-300-reverse": "linear-gradient(180deg, #6ee7c1 0%, #ecfdf8 100%)",
