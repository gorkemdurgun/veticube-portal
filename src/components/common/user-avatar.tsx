  ...
  return (
    ...
    >
      <Avatar
        size="small"
        shape="square"
        className="w-5 h-5 capitalize bg-gray-200 text-gray-500"
        icon={userData?.first_name?.charAt(0)}
      />
      <span className="text-sm text-gray-500">{`${userData?.first_name} ${userData?.last_name}`}</span>
